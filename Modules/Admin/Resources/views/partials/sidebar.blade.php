      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ url('public/admin/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ url('public/admin/dist/img/user3-128x128.jpg')}}" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{request()->segment(2)=='category' || request()->segment(2)=='edit-category' ? 'active':''}}">
         ...
         <li class="{{request()->segment(2)=='document-setting' ? 'active':''}}">
          <a href="{{ url('admin/document-setting')}}">
